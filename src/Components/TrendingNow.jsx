        ...
        {this.state.error && (
          <div className="text-center w-100">
            <Alert variant="danger" className="w-50 mx-auto mt-4">
              Abbiamo scontrato un errore nel caricamento dei file. Contatta la
              polizia postale per maggiori informazioni oppure chiama al numero
              verde 1245412 dove offriamo uno psicologo per aiutarti a superare
